...
```{r, echo = FALSE}
knitr::include_graphics("connected1.png", error = FALSE)
```
...
```{stata, echo = TRUE, changelog = FALSE}
...
The Github code for this R Markdown tutorial is located [here](https://github.com/mbounthavong/STATA-programming-and-codes/blob/4201dedddd943a546f5fa8df06bc3060296f7904/two-way%20line%20plot%20and%2095%25%20confidence%20intervals).
